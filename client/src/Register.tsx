...
function Register() {
  ...
  const navigate = useNavigate(); // --- 1. Validation Logic ---
  ...
  const validateInputs = () => {
    ...
    } // B. Check Password (8 chars, letters + numbers) // Regex: At least 1 letter, 1 number, 8+ characters
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Old: "http://localhost:3001/register" -> New: "/register"
